...
![Tests: 138 bestanden](https://img.shields.io/badge/tests-138%20passing-brightgreen)
...
138 Tests in 13 Suiten, die ihre Testdateien selbst konstruieren (zusätzlich benötigt: `reportlab`, `playwright`). `test_block1`, `test_block2` und `test_blockI_batch` nutzen den Code direkt bzw. den Flask-Testclient; für alle anderen muss der Server laufen (`python app.py`):
